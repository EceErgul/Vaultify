  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-inter">
      <div className="bg-white w-full max-w-[800px] min-h-[550px] sm:min-h-[600px] border border-gray-300 shadow-sm relative flex flex-col items-center pt-14 pb-8 px-4 sm:px-10 text-[#333D50] rounded-xl sm:rounded-none">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-black mb-1 sm:mb-2 text-center">Tekrar hoş geldiniz.</h2>
        ...
        >
          ...
          <span className="text-xs sm:text-sm font-medium text-[#333D50] whitespace-nowrap">Google İle Giriş Yap</span>
        </button>
        ...
        <form onSubmit={handleLogin} className="w-full max-w-md flex flex-col items-center">
          <div className="space-y-4 w-full">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center gap-1.5 sm:gap-4 w-full">
              <label className="text-xs sm:text-sm font-medium sm:w-32 sm:text-right">E-posta adresiniz:</label>
              <input 
                type="email"
                value={email}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center gap-1.5 sm:gap-4 w-full">
              <label className="text-xs sm:text-sm font-medium sm:w-32 sm:text-right">Şifreniz:</label>
              <input 
                type="password"
                value={password}
