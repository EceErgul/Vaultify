...
const Button: React.FC<ButtonProps> = ({ variant = 'add', children, className = '', ...props }) => {
  ...
  const baseStyles = "h-[26px] sm:h-[35px] px-3 sm:px-6 text-xs sm:text-sm rounded-lg border border-black shadow-sm font-medium transition-all duration-150 flex items-center justify-center gap-2 flex-shrink-0 whitespace-nowrap";
